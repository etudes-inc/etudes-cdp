/**********************************************************************************
 * $URL: https://source.etudes.org/svn/e3/cdp/trunk/cdp-util/util/src/java/org/etudes/cdp/util/StringHtml.java $
 * $Id: StringHtml.java 6048 2013-09-25 23:20:03Z ggolden $
 ***********************************************************************************
 *
...
public class StringHtml
{
	...
	{
		boolean hit = false;
		Pattern p = Pattern.compile("\\[quote\\s*=\\s*(.*?)\\](.*?)\\[/quote\\]", Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CASE | Pattern.DOTALL);
		int pass = 0;
		while (true)
		{
